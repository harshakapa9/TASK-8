...
import { 
  faEnvelope, faMapMarkerAlt, faPhone, faSearch, 
  faShoppingCart, faBars, faChevronRight, faGem 
          ...
          <div className="topbar-one__inner">
            <ul className="list-unstyled topbar-one__info">
              <li className="topbar-one__info__item">
                <span className="topbar-one__info__icon">
                <svg className="white" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1.25em" width="1.25em" xmlns="http://www.w3.org/2000/svg"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8l8 5 8-5v10zm-8-7L4 6h16l-8 5z"></path></svg> 
                    </span>
                <a href="mailto:info@ienetmail.com">info@ienetwork.com</a>
              </li>
              <li className="topbar-one__info__item">
                <span className="topbar-one__info__icon">
                <svg className='white' stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 12 16" height="1.25em" width="1.25em" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6 0C2.69 0 0 2.5 0 5.5 0 10.02 6 16 6 16s6-5.98 6-10.5C12 2.5 9.31 0 6 0zm0 14.55C4.14 12.52 1 8.44 1 5.5 1 3.02 3.25 1 6 1c1.34 0 2.61.48 3.56 1.36.92.86 1.44 1.97 1.44 3.14 0 2.94-3.14 7.02-5 9.05zM8 5.5c0 1.11-.89 2-2 2-1.11 0-2-.89-2-2 0-1.11.89-2 2-2 1.11 0 2 .89 2 2z"></path></svg>
                  {/* <FontAwesomeIcon icon={faMapMarkerAlt} size="md" /> */}
                </span>
                221B Baker Street, Bengaluru, India
              </li>
            </ul>
